...
class ProjectEditPage(BasePage):
    ...
    #_START_EDITING_BUTTON = (By.XPATH,"//*[contains(text(),'START EDITING')]")
    _START_EDITING_BUTTON = (By.XPATH,"//*[@id='new-project-form']/div[2]/div/div[1]/label/div/button")
    ...
    def edit_project_prep(self, project_name, project_type):
        ...
        if project_type == "Thank you page": # thank you page
